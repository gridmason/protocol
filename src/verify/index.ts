 ...
 *
 * Content hashing (§4.1), dual-signature envelope verification (§4.2), signed
 * revocation-feed authentication + revocation-feed freshness (§4.3),
 * transparency-log proofs (§4.3), trust-root
