 ...
 *
 * Content hashing (§4.1), revocation-feed freshness (§4.3), and trust-root
 * parsing/pinning/rotation (§4.4) have landed; the signature and log checks are
 * populated by the rest of the P-E3 epic.
 */
